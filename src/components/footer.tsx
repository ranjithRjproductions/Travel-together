...
export function Footer() {
  return (
    <>
      <footer role="navigation" aria-label="Footer" className="bg-background border-t">
      ...
      <div role="contentinfo" className="bg-background">
        <p className="container mx-auto px-4 py-6 border-t text-center text-sm text-muted-foreground">
